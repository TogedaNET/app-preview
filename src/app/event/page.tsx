...
export default async function EventPage({
  ...
  return (
    <div className="relative min-h-screen text-white">
      ...
      <div className="mx-auto w-full max-w-300">
        <div className="md:grid md:grid-cols-2">
          ...
          <div className="flex flex-col gap-5 px-6 pt-2 pb-28 md:py-8 md:pb-28 lg:px-10 lg:py-12 lg:pb-12">
            ...
            <JoinCTA type="event" id={id} count={event.participantsCount} interests={event.interests} location={event.location} payment={event.payment} currency={event.currency} />
      ...
      <StickyJoinBar type="event" id={id} count={event.participantsCount} interests={event.interests} location={event.location} payment={event.payment} currency={event.currency} />
    </div>
  );
}
